...
{
    /// <inheritdoc />
    public partial class zer0 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DatabaseAuthor", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DatabaseAuthor = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    AspNetUsers = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    LastTaken = table.Column<DateTime>(type: "datetime", nullable: false),
                    LastToReturn = table.Column<DateTime>(type: "datetime", nullable: false),
                    BookImage = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DatabaseBook", x => x.Id);
                    table.ForeignKey(
